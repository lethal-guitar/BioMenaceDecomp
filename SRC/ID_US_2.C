...
typedef enum
    {
      ...
      uic_DrawIcon,uic_Draw,uic_Hit,uic_Dummy1, uic_Dummy2
    } UserCall;
...
static  boolean USL_ConfigCustom(UserCall call,struct UserItem far *item),
        ...
        USL_HelpCustom(UserCall call,struct UserItem far *item);
...
#define CustomGroup(title,key,custom)   0,0,title,key,0,custom
  ...
  UserItemGroup   far helpgroup = {0,0,0,sc_None,0,USL_HelpCustom};
