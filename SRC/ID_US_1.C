...
static  boolean         US_Started;
    ...
    HighScore       Scores[MaxScores] =
          {
            {"Apogee Software - '93",10000,0},
            {"",10000,0},
            {"Jim Norwood - Designer",10000,0},
            {"George Broussard - Producer",10000,0},
            {"Bobby Prince - Music",10000,0},
            {"Joe Siegler - BBS Support",10000,0},
            {"ID Software - Game Engine",10000,0},
            {"",10000,0},
          };
